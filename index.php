...
<body>
    ...
    <main>
                ...
                <div class="swiper-container homeswiper-01">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div data-swiper-parallax="-100">
                                <div class="section-parallax slide-img"
                                    style="background-image:url(assets/images/index-back2.jpg);">
                                </div>
                            </div>
                                    ...
                                    <div data-swiper-parallax="-300">
                                        <div class="slideshow">
                                            <span class="slide-text text-white animated di-1 me-md-3 me-2"
                                                data-animation="fadeInUp">Bizim</span>
                                            <span class="slide-text text-blue animated di-1 me-md-3 me-2"
                                                data-animation="fadeInDown">Amacımız</span>
                                            <span class="slide-text text-white animated di-1"
                                                data-animation="fadeInUp">Yenilikçilik</span>
                                            <p class="slide-text mt-3 mb-4 text-white animated di-1-5 me-3"
                                                data-animation="fadeInUp">Yenilikçi, göz alıcı çözümler sunuyoruz
                                                markaların kalabalığın arasından sıyrılmasına yardımcı oluyoruz</p>
                                            <div class="w-100"></div>
                                            <a href="services.php"
                                                class="btn-eff-01 btn-eff-01-pre me-md-4 me-3 my-md-0 my-3 animated di-2"
                                                data-animation="fadeInUp">Daha Fazla</a>
                                            <a href="about.php" class="btn-eff-01 btn-eff-03-pre animated di-2-5"
                                                data-animation="fadeInUp"><span
                                                    class="btn-eff-03-pre-bg"></span>Keşfet</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div data-swiper-parallax="-100">
                                <div class="section-parallax slide-img"
                                    style="background-image: url(assets/images/index-back1.jpg);">
                                </div>
                            </div>
                            <div class="section-mask"></div>
                            <div class="section-content text-center">
                                <div class="container">
                                    <div data-swiper-parallax="-300">
                                        <div class="slideshow">
                                            <span class="slide-text text-white animated di-1 me-md-3 me-2"
                                                data-animation="fadeInUp">Tasarımda</span>
                                            <span class="slide-text text-yellow animated di-1 me-md-3 me-2"
                                                data-animation="fadeInDown">Arzulanan</span>
                                            <span class="slide-text text-white animated di-1"
                                                data-animation="fadeInUp">Güç</span>
                                            <p class="slide-text mt-3 mb-4 text-white animated di-1-5 me-3"
                                                data-animation="fadeInUp">Tasarım sanatına karşı bitmeyen tutku
                                             müşterilerimiz için hayal bile edilemeyecek harikalar oluşturmak için Çalışıyoruz</p>
                                            <div class="w-100"></div>
                                            <a href="contacts.php"
                        ...
                        <div class="swiper-slide">
                            <div data-swiper-parallax="-100">
                                <div class="section-parallax slide-img"
                                    style="background-image: url(assets/images/index-back3.jpg);">
                                </div>
                            </div>
                            <div class="section-mask"></div>
                            <div class="section-content text-center">
                                <div class="container">
                                    <div data-swiper-parallax="-300">
                                        <div class="slideshow">
                                            <span class="slide-text text-white animated di-1 me-md-3 me-2"
                                                data-animation="fadeInUp">Basitlik</span>
                                            <span class="slide-text text-blue animated di-1 me-md-3 me-2"
                                                data-animation="fadeInDown">İlham verici</span>
                                            <span class="slide-text text-white animated di-1"
                                                data-animation="fadeInUp">Tasarım</span>
                                            <p class="slide-text mt-3 mb-4 text-white animated di-1-5 me-3"
                                                data-animation="fadeInUp">Her harika iş fikri,
                                                profesyonelce tasarlanmış bir web sitesinin lansmanı üzerine çalışıyoruz.</p>
                                            <div class="w-100"></div>
                                            <a href="about.php"
                                                class="btn-eff-01 btn-eff-03-pre me-md-4 me-3 my-md-0 my-3 animated di-2"
                                                data-animation="fadeInUp"><span class="btn-eff-03-pre-bg"></span>Daha Fazla Öğren</a>
                                            <a href="services.php"
                ...
                <div class="row">
                    <div class="col-lg-4 p-md-0">
                        <div class="p-5 section-yellow">
                            <h4>Strateji</h4>
                            <p class="pt-4">Gelecekteki kullanıcılarınızı doğruladığımız ve proje omurgasını tanımladığımız yer burasıdır.
                                Kullanıcıların ihtiyaçlarının bir çözümle karşılandığı bir çalışma planından oluşur.
                                iş hedeflerini yerine getiririz</p>
                        </div>
                    </div>
                    <div class="col-lg-4 p-md-0">
                        <div class="p-5 section-light">
                            <h4>Pazarlama</h4>
                            <p class="pt-4 text-text">Dijital pazarlama, önde olmanın tek yoludur.
                                işletme sahibi için çevrimiçi dünya göz korkutucu görünebilir, biz işletmenize
                                başarılı bir dijital planlama hazırlıyoruz, pazarlama artık daha kolay.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 p-md-0">
                        <div class="p-5 section-blue">
                            <h4>Teknoloji</h4>
                            <p class="pt-4">Tanışacağınız ilk kişiler teknik uzmanlarımızdır.
                                işiniz hakkında detaylar , iş kapsamını, zorlukları tartışın 
                                size en uygun olanlara danışmanızı sağlıyoruz
                               </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="section-content-v pe-lg-5 pe-0">
                            <h2 class="mb-3">Akıllı Çalışma</h2>
                            <p class="text-text">Her harika iş fikri, bir şirketin piyasaya sürülmesiyle kanatlanır.
                                profesyonelce tasarlanmış web sitesi ve Sefarm Şirketi belirli bir misyonla oluşturulmuş olsa da
                                Uygun bir fiyata profesyonel olmak isteyen işletme sahiplerine yardımcı olmak bizim misyonumuz.
                            </p>
                            <a href="about.php" class="btn-eff-01 btn-eff-01-pre mt-4">Keşfet</a>
                        </div>
                    </div>

                    <div class="col-lg-6">
                        <div class="section-content-v">
                            <img src="assets/images/index-img1.jpg" width="600" height="298"
                                class="img-fluid mt-5 mt-lg-0"
                                srcset="assets/images/index-img1.jpg 600w, assets/images/index-img1.jpg 400w"
                                sizes="(min-width: 992px) 600px, 50vw" alt="Sefarm Locatıon" />
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="img-overlay-02">
                            <img src="assets/images/index-img2.jpg" width="700" height="1050"
                                class="img-fluid"
                                srcset="assets/images/index-img2.jpg 400w, assets/images/index-img2.jpg 700w"
                                sizes="(min-width: 992px) 400px, 50vw" alt="Keep things in proportion SefarmCompany" />
                            <div class="overlay-02 overlay-blue"></div>
                            <div class="section-content-v-02">
                                <div class="text-center overlay-text-02">
                                    <h6 class="text-white font-size-1-5">Her şeyi orantılı tutun</h6>
                                    <p class="text-white mt-3">Çok büyük değil, çok küçük değil. Yaparak motive oluyoruz
                                        iyi iş işimizi büyütmememiz için en iyi olanak</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="img-overlay-02">
                            <img src="assets/images/index-img3.jpg" width="700" height="400"
                                class="img-fluid"
                                srcset="assets/images/index-img3.jpg 400w, assets/images/index-img3.jpg 700w"
                                sizes="(min-width: 992px) 400px, 50vw" alt="Put people first SefarmCompany" />
                            <div class="overlay-02 overlay-dark"></div>
                            <div class="section-content-v-02">
                                <div class="text-center overlay-text-02">
                                    <h6 class="text-white font-size-1-5">Önce İnsanlık</h6>
                                    <p class="text-white mt-3">Bu bizim tasarım felsefemiz ve projemize yaklaşma şeklimiz.
                                        işimiz, ekibimiz ve müşterilerimiz beraber büyüyoruz</p>
                                </div>
                            </div>
                        </div>
                        <div class="vh-21 px-lg-5">
                            <div class="section-content-v text-center">
                                <h4>Marka <span class="text-blue">Strateji</span></h4>
                                <p class="text-text py-4">Kişiye özel strateji planı ile markanızı görünür olmanızı hedefliyoruz.
                                    </p>
                                <a href="services.php" class="btn-eff-03">Daha Fazla</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="img-overlay-02">
                            <img src="assets/images/index-img4.jpg" width="700" height="1050"
                                class="img-fluid"
                                srcset="assets/images/index-img4.jpg 400w, assets/images/index-img4.jpg 700w"
                                sizes="(min-width: 992px) 400px, 50vw" alt="Graphic Design SefarmCompany" />
                            <div class="overlay-02 overlay-yellow"></div>
                            <div class="section-content-v-02">
                                <div class="text-center overlay-text-02">
                                    <h6 class="text-dark font-size-1-5">Grafik Tasarım</h6>
                                    <p class="text-dark mt-3">Her türlü yüksek kaliteli grafik öğesini özenle tasarlıyoruz.
                                       </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="img-overlay-02">
                            <img src="assets/images/index-img5.jpg " width="700" height="400"
                                class="img-fluid"
                                srcset="assets/images/index-img5.jpg  400w, assets/images/index-img5.jpg  700w"
                                sizes="(min-width: 992px) 400px, 50vw" alt="See the bigger picture SefarmCompany" />
                            <div class="overlay-02 overlay-dark"></div>
                            <div class="section-content-v-02">
                                <div class="text-center overlay-text-02">
                                    <h6 class="text-white font-size-1-5">Büyük Resmi Görün</h6>
                                    <p class="text-white mt-3">Nereden geldiğinizi anlamak, birlikte doğru yöne ilerlememize yardımcı olur.
                                        </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="img-overlay-02">
                            <img src="assets/images/index-img6.jpg" width="700" height="400"
                                class="img-fluid"
                                srcset="assets/images/index-img6.jpg 400w, assets/images/index-img6.jpg 700w"
                                sizes="(min-width: 992px) 400px, 50vw" alt="Think globally SefarmCompany" />
                            <div class="overlay-02 overlay-yellow"></div>
                            <div class="section-content-v-02">
                                <div class="text-center overlay-text-02">
                                    <h6 class="text-dark font-size-1-5">Evrensel Düşün.</h6>
                                    <p class="text-dark mt-3">Uluslararası müşterilerimiz ve meslektaşlarımız bize ilham veriyor
                                        iş ve yaşam hakkında yeni bakış açıları kazanıyoruz.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="img-overlay-02">
                            <img src="assets/images/index-img7.jpg" width="700" height="400"
                                class="img-fluid"
                                srcset="assets/images/index-img7.jpg 400w, assets/images/index-img7.jpg 700w"
                                sizes="(min-width: 992px) 400px, 50vw" alt="Never stop learning SefarmCompany" />
                            <div class="overlay-02 overlay-blue"></div>
                            <div class="section-content-v-02">
                                <div class="text-center overlay-text-02">
                                    <h6 class="text-white font-size-1-5">Öğrenmeyi Asla Bırakma</h6>
                                    <p class="text-white mt-3">Teknoloji hızlı ilerliyor. Tasarım ilerliyor. yani bu önemli
                                        öğrenmeye devam ediyoruz, Her zaman güncel kalıyoruz.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="section-content-v">
                            <div class="row">
                                <div class="col-lg-4 col-md-4 text-center">
                                    ...
                                    <div class="text-text mt-3 font-size-1-06 fst-italic">Mükemmel tasarım</div>
                                </div>
                                <div class="col-lg-4 col-md-4 mt-md-0 mt-5 text-center">
                                    ...
                                    <div class="text-text mt-3 font-size-1-06 fst-italic">Optimizasyon</div>
                                </div>
                                <div class="col-lg-4 col-md-4 mt-md-0 mt-5 text-center">
                                    <svg class="svg svg-home svg-blue" enable-background="new 0 0 154 160"
                                        viewBox="0 0 154 160" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="text-text mt-3 font-size-1-06 fst-italic">Markalaşma</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-5">
                        <div class="section-content-v ps-lg-5 ps-0">
                            <h3 class="font-size-3 mb-3">Bizim uzmanlığımız</h3>
                            <p class="text-text">Geniş bir yelpazeye sahip, stratejik, yaratıcı ve uzmanlığın hünerli bir karışımı
                                becerilerin yanı sıra, tüketicilerimiz için ilgili ve yenilikçi çözümler sunmak için çok çalışıyoruz.
                            </p>
                        </div>
                    </div>
        ...
        <section class="section-parallax page-image-sec"
            style="background-image: url(assets/images/index-back4.jpg);">
            <div class="section-mask"></div>
            <div class="section-content-v">
                <div class="container">
                    <div class="row justify-content-end">
                        <div class="col-lg-6">
                            <div class="p-5 section-light">
                                <h4 class="font-size-3">Kendi  <span class="text-blue">projeni</span> Oluştur!</h4>
                                <p class="text-text py-4">İyi müşteri ilişkileri bizim için de çok önemlidir. bizim
                                    uzmanlarımızn işlerinde çok tekniktir, SefarmCompany'teki herkes uzmanlığı ile işin üzerine yoğunlaşır.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-lg-0 mb-5">
                        <div class="section-content-v">
                            <h2 class="font-size-2-5 mb-3">Biz Kimiz?</h2>
                            <p class="text-text pe-lg-5 pe-0">Sefarm bir web tasarım ve sistem geliştirme şirketidir.
                                sınırsız stiller, e-çözümler, dijital
                                pazarlama, siber güvelik iş uygulaması ve Mobil çözümler sunan bir yazılım şirketidir.</p>
                        </div>
                    </div>
                        ...
                        <div class="section-content-v">
                            <div class="progress">
                                <div class="progress-bar progress-bar-striped bg-yellow progress-bar-animated"
                                    ...
                                    data-max="90"></div>
                                <div class="progress_title">Tasarım</div>
                            ...
                            <div class="progress">
                                <div class="progress-bar progress-bar-striped bg-blue progress-bar-animated"
                                    ...
                                    data-max="93"></div>
                                <div class="progress_title">Yenilik</div>
                            ...
                            <div class="progress">
                                <div class="progress-bar progress-bar-striped bg-dark progress-bar-animated"
                                    ...
                                    data-max="85"></div>
                                <div class="progress_title">Pazarlama</div>
                    ...
                    <div class="col-lg-12">
                        <div class="swiper-container homeswiper-02">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img src="assets/images/index-swipe8.png"
                                        class="img-fluid swipe-img-02" alt="Vue Js SefarmCompany" />
                                </div>

                                <div class="swiper-slide">
                                    <img src="assets/images/index-swipe1.png"
                                        class="img-fluid swipe-img-02" alt="Bootstrap SefarmCompany" />
                                </div>

                                <div class="swiper-slide">
                                    <img src="assets/images/index-swipe2.png"
                                        class="img-fluid swipe-img-02" alt="JQuery SefarmCompany" />
                                </div>

                                <div class="swiper-slide">
                                    <img src="assets/images/index-swipe3.png"
                                        class="img-fluid swipe-img-02" alt="Angular SefarmCompany" />
                                </div>

                                <div class="swiper-slide">
                                    <img src="assets/images/index-swipe4.png"
                                        class="img-fluid swipe-img-02" alt="CSS3 SefarmCompany" />
                                </div>

                                <div class="swiper-slide">
                                    <img src="assets/images/index-swipe5.png"
                                        class="img-fluid swipe-img-02" alt="JAVA SefarmCompany" />
                                </div>

                                <div class="swiper-slide">
                                    <img src="assets/images/index-swipe6.png"
                                        class="img-fluid swipe-img-02" alt="React SefarmCompany" />
                                </div>

                                <div class="swiper-slide">
                                    <img src="assets/images/index-swipe7.png"
                                        class="img-fluid swipe-img-02" alt="HTML5 SefarmCompany" />
                                </div>
